...
export default class Bearfoot extends Component{
    render(){
        return(
            <div htmlFor="bearfoot">
                <h4>Bearfoot</h4>
                <a target="_blank" href="https://craragon77.github.io/hiking-program/" rel="noopener noreferrer"><img src={Bearfoot_Pic} alt="Bearfoot snapshot"/></a>
                <div>
