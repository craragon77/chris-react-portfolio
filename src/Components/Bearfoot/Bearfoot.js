    ...
    render(){
        return(
                <section htmlFor="bearfoot">
                    <h4 className="bearfoot_title">Bearfoot</h4>
                    <div className="bearfoot-flex-container">
                        ...
                        <div>
                            <p className="what_is_it">Bearfoot is a program designed to find hiking trails near you.
